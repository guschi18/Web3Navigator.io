  ...
  return (
    ...
    <div className="flex justify-between items-center border-y border-black py-10 lg:py-0">
      <div className="px-10 space-y-5">
        <h1 className="text-5xl max-w-xl font-serif"><span className="underline decoration-blck decoraction-4">WEB3 Navigator</span>{" "} deine Platform, um sicher im Web 3 zu navigieren und Blockchain zu verstehen! </h1>
