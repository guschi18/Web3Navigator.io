...
export default function SubscribePage() {
  ...
  return (
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      ...
      <h2 class="mb-4 text-3xl tracking-tight font-extrabold text-black sm:text-3xl dark:text-white">Abonniere unseren Newsletter</h2>
      <p class="mx-auto mb-8 max-w-2xl font-light text-gray-600 md:mb-12 sm:text-xl dark:text-gray-600">Verpasse keine Neuigkeiten zu unserem Roadmap-Fortschritt und spannenden Ankündigungen! Melde dich jetzt mit deiner E-Mail-Adresse an und bleibe über unseren Blog auf dem Laufenden.</p>
