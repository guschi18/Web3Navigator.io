...
const Footer = () => {
  return (
    ...
    <Link href="/mitgliederbereich" className="flex items-center mb-4 sm:mb-0">
            <Image
    ...
    <hr className="my-6 border-black sm:mx-auto lg:my-8" />
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link href="/mitgliederbereich" className="hover:underline">Web3Navigator™</Link>. Alle Rechte vorbehalten.</span>
    </div>
</footer>
)
}
