...
export default function Login() {
  ...
  return (
    ...
    <div className="lg:col-span-4 bg-gradient-to-br from-cyan-800 via-cyan-900 to-green-800">
    <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
      <div className="bg-gradient-to-br from-black via-cyan-900 to-green-800 p-2 rounded-xl">
    ...
    <header className="flex items-center justify-between">
      ...
      <h1 className="text-3xl p-5 font-bold lg:text-4xl lg:font-extrabold"> Der Web3Navigator Ape Club | <Link href="/mitgliederbereich">
        <span className="font-extrabold underline decoration-green-800/90">Mitgliederbereich</span></Link></h1>
        <p className="text-xl p-5 font-bold lg:text-xl lg:font-bold">Logge dich mit deinem NFT ein um exklusiven Content im 
        Mitgliederbereich zu erhalten🖤</p>
      </div>
      </div>
    </div>
  );
